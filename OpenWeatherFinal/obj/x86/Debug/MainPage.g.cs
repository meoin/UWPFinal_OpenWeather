        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 169 && columnNumber == 77)
                {
                ...
                else if (lineNumber == 149 && columnNumber == 81)
                {
                    isobj14TextDisabled = true;
                }
                else if (lineNumber == 145 && columnNumber == 77)
                {
                ...
                else if (lineNumber == 124 && columnNumber == 51)
                {
                    isobj17TextDisabled = true;
                }
                else if (lineNumber == 133 && columnNumber == 80)
                {
                    isobj19TextDisabled = true;
                }
                else if (lineNumber == 128 && columnNumber == 80)
                {
                    isobj21TextDisabled = true;
                }
                else if (lineNumber == 115 && columnNumber == 74)
                {
                    isobj22TextDisabled = true;
                }
                else if (lineNumber == 111 && columnNumber == 75)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 21: // MainPage.xaml line 128
                        ...
                        break;
                    case 22: // MainPage.xaml line 115
